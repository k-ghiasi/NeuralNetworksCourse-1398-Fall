...
fig = plt.figure()
metadata = dict(title='TwoClassPerceptronMultiprototypeBipolarXor', artist='Matplotlib',
                comment='Movie support!')
pillowWriter = animation.writers['pillow']
moviewriter = pillowWriter(fps=2, metadata=metadata)
moviewriter.setup(fig=fig, outfile='TwoClassPerceptronMultiprototypeBipolarXor.gif', dpi=150)
